...
from deepthought.tools.math_ops import add_values, divide_values, multiply_values
...
EXECUTION_TOOLS = [query_dynamodb, add_values, multiply_values, divide_values]
VERIFICATION_TOOLS = [verify_addition, verify_multiplication, verify_division]
